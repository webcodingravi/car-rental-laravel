  <nav
      class="flex items-center justify-between md:px-32 px-6 border-b border-slate-200 py-4 bg-slate-100 transition-all duration-500 sticky top-0 left-0 z-[999] text-gray-600">
